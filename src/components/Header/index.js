...
//     Axios.get(APIURLConstants.GET_DATA)
    ...
    <>
      ...
      <header className="it-header-height">
        <div className="it-header-2-top-area it-header-5-top-style theme-bg-4">
          <div className="container container-1380">
            <div className="row align-items-center">
              <div className="col-xl-10 col-lg-6 col-md-5">
                <div className="it-header-2-top-left">
                  <ul className="text-center text-sm-start">
                  <li className="d-none d-xl-inline-block">
                      <a href="#">
                    ...
                    <li>
                      <a href="#">
                        ...
                        Kandri, Maharashtra 441404
                      </a>
                    </li>  

                    <li>
                      
                    <button  className='it-btn-virtualtour radius'
                      onClick={() => {
                        openModal();
                      }}
                    > 
              ...
              <div className="col-xl-2 col-lg-6 col-md-7 col-sm-6 d-none d-md-block">
        ...
        <div
          id="header-sticky"
          className={`it-header-5-area it-header-5-style ${isVisible ? 'header-sticky' : ''
            }`}
        >
          <div className="container container-1380">
            <div className="it-header-wrap p-relative">
      ...
      <div className="it-offcanvas-area">
        <div className={offCanvasOpen ? 'itoffcanvas opened' : 'itoffcanvas'}>
          ...
          <div className="itoffcanvas__text">
            <p>
              Leela’s International School, one of the best educational institutions in the Kanhan/Kandri area, is dedicated to fostering a nurturing and inclusive learning environment where every student can thrive.
            </p>
          </div>
          <div className="it-menu-mobile">
            <MobileMenuItems onePage={menuFormat} />
          ...
          <div className="itoffcanvas__info">
            ...
            <div className="it-info-wrapper mb-20 d-flex align-items-center">
              ...
              <div className="itoffcanvas__info-address">
                <span>Email</span>
                <a href="maito:hello@yourmail.com">admin@leelaschool.com</a>
              </div>
            </div>
            <div className="it-info-wrapper mb-20 d-flex align-items-center">
              <div className="itoffcanvas__info-icon">
              ...
              <div className="itoffcanvas__info-address">
                <span>Phone</span>
                <a href="tel:(00)45611227890">(+91) 97308 55553</a>
              </div>
            </div>
            <div className="it-info-wrapper mb-20 d-flex align-items-center">
              <div className="itoffcanvas__info-icon">
